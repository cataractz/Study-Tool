...
export const neuroOphthalmologyAdditional4: Disease[] = [
  {
    ...
    managementProtocol: {
      workup: [
        'MRI brain with and without contrast, dedicated pineal region protocol, to identify the causative dorsal midbrain lesion',
        'Serum and CSF tumor markers (AFP, beta-hCG) when a pineal region mass is found, to help differentiate germinoma from other germ cell tumors',
        'Lumbar puncture with CSF cytology (after imaging excludes a mass with obstructive risk) to assess for leptomeningeal spread and confirm opening pressure',
        'Formal ocular motility and pupillary examination with optokinetic testing to confirm the specific pattern of the syndrome',
      ],
      initialTreatment: 'Management is directed entirely at the underlying dorsal midbrain lesion, not the eye findings themselves: ventriculoperitoneal shunt or endoscopic third ventriculostomy for obstructive hydrocephalus, and surgical biopsy/resection, radiotherapy (germinomas are highly radiosensitive), and/or chemotherapy per tumor type.',
      followUpSchedule: 'Determined by underlying etiology and treatment; oncology/neurosurgery follow the tumor with serial MRI, while neuro-ophthalmology follows vertical eye movements, pupillary responses, lid position, and disc appearance in parallel.',
      escalationCriteria: [
        'New or worsening symptoms of raised intracranial pressure (headache, nausea, papilledema) — urgent neurosurgical evaluation for hydrocephalus and herniation risk',
        'Worsening upgaze palsy or new downgaze involvement — repeat imaging for tumor growth or worsening hydrocephalus',
      ],
      referralCriteria: [
        'Any pineal region mass -> urgent neurosurgery and neuro-oncology',
        'Suspected demyelinating or vascular etiology -> neurology',
      ],
      complications: [
        'Persistent upgaze deficit and convergence-retraction nystagmus despite treatment of the underlying lesion',
        'Hydrocephalus recurrence',
        'Treatment-related morbidity (radiation, surgery)',
        'Herniation if obstructive hydrocephalus is untreated',
      ],
      monitoringParameters: [
        'Vertical eye movements',
        'Pupillary light and near responses',
        'Lid position',
        'Visual fields',
        'Optic disc appearance for papilledema',
        'Serial MRI',
      ],
      relatedExamTechniqueIds: ['pupillary-examination', 'optokinetic-nystagmus-testing', 'extraocular-motility-testing'],
    },
    followUp: {
  ...
  },
  {
    ...
    managementProtocol: {
      workup: [
        'Mitochondrial DNA genetic testing (blood) to confirm one of the primary LHON point mutations',
        'MRI brain/orbits with contrast to exclude a compressive or demyelinating mimic',
        'Formal automated visual field testing to characterize the cecocentral scotoma',
        'OCT retinal nerve fiber layer to stage disease (acute pseudoedema versus chronic thinning)',
        'Fluorescein angiography to confirm the swollen disc shows no true leakage (pseudoedema)',
        'Family/pedigree history and screening of maternal relatives',
      ],
      initialTreatment: 'Idebenone 900 mg/day (300 mg three times daily), a synthetic coenzyme Q10 analog/antioxidant, is the therapy with clinical trial evidence (RHODOS trial) for modest benefit in visual stabilization/recovery, particularly when started early in the disease course; regulatory approval and availability vary by region. No treatment reliably reverses established vision loss, so regular monitoring is otherwise central to management.',
      followUpSchedule: 'Every few months during the active phase of vision loss to monitor for fellow-eye involvement and treatment response, then annually once stable.',
      escalationCriteria: [
        'Continued decline beyond the expected fellow-eye involvement window (weeks to about a year) — reconsider the diagnosis',
        'Atypical unilateral-only presentation beyond the expected window — repeat workup for an alternative cause',
        'Emerging systemic neurologic features — evaluate for an "LHON plus" phenotype',
      ],
      referralCriteria: [
        'All confirmed or suspected cases -> genetic counseling for the patient and at-risk maternal relatives',
        'All cases -> neuro-ophthalmology for diagnosis confirmation and ongoing management',
        'Significant bilateral central vision loss -> low vision rehabilitation',
      ],
      complications: [
        'Severe, often legally-defining, bilateral central vision loss',
        'Functional disability from loss of central vision, though peripheral vision is typically preserved',
        '"LHON plus" phenotypes (MS-like illness, cardiac pre-excitation/Wolff-Parkinson-White syndrome)',
      ],
      monitoringParameters: [
        'Visual acuity',
        'Color vision',
        'Visual fields',
        'OCT RNFL',
        'Development of any systemic ("LHON plus") features',
      ],
      relatedExamTechniqueIds: ['humphrey-visual-field', 'oct-optic-nerve-rnfl', 'farnsworth-munsell-d15', 'fluorescein-angiography'],
    },
    followUp: {
  ...
  },
  {
    ...
    managementProtocol: {
      workup: [
        'Detailed medication, dietary, alcohol, and toxin exposure history — the single most important diagnostic step',
        'Serum vitamin B12, methylmalonic acid, homocysteine, and folate levels',
        'Thiamine level (or empiric clinical response to replacement), particularly in malnourished or alcohol-use-disorder patients',
        'Serum methanol level and arterial blood gas with anion/osmolar gap when methanol toxicity is suspected',
        'MRI brain and orbits to exclude a compressive or demyelinating cause when the exposure history is unclear',
        'Automated visual field testing to characterize the cecocentral scotoma',
      ],
      initialTreatment: 'Immediate discontinuation or dose reduction of the offending medication (ethambutol, amiodarone) in coordination with the prescribing physician, complete cessation of alcohol/tobacco use when implicated, and replacement of the deficient nutrient (vitamin B12, folate, and/or thiamine) — thiamine should be given before or with glucose administration in at-risk patients to avoid precipitating Wernicke encephalopathy.',
      followUpSchedule: 'Every 4-6 weeks initially after removing the offending agent or starting replacement therapy to document visual improvement, then less frequently once stable; patients continuing ethambutol require ongoing periodic screening (baseline, then monthly visual acuity and color vision testing, particularly at doses of 25 mg/kg/day or greater).',
      escalationCriteria: [
        'Continued decline despite removal of the suspected agent or correction of the deficiency — reconsider the diagnosis and pursue further workup',
        'Acute severe bilateral vision loss with metabolic acidosis — treat as methanol toxicity, a medical emergency',
        'Any patient on ethambutol reporting new visual symptoms — discontinue the drug immediately pending evaluation',
      ],
      referralCriteria: [
        'Nutritional and systemic workup -> internal medicine/primary care',
        'Alcohol use disorder -> addiction medicine',
        'Continued clinical need for the causative medication -> co-management with the prescribing specialist for risk-benefit reassessment',
        'Suspected methanol ingestion -> emergency department immediately',
      ],
      complications: [
        'Permanent central visual field loss and optic atrophy if diagnosis and intervention are delayed',
        'Irreversible blindness and death with untreated methanol toxicity',
        'Wernicke encephalopathy if thiamine deficiency is untreated or glucose is given before thiamine',
      ],
      monitoringParameters: [
        'Visual acuity',
        'Color vision',
        'Visual fields (cecocentral scotoma size/depth)',
        'Periodic screening (visual acuity, color vision) for patients continuing ethambutol therapy',
      ],
      relatedExamTechniqueIds: ['humphrey-visual-field', 'farnsworth-munsell-d15', 'ishihara-color-vision-screening'],
    },
    followUp: {
  ...
  },
  {
    ...
    managementProtocol: {
      workup: [
        'Thin-section CT of the orbits and optic canals without contrast as first-line imaging to assess for canal fracture or compressive hematoma',
        'Serial pupillary examination for RAPD, graded with neutral density filters, especially when acuity cannot be reliably tested',
        'MRI orbits/brain with fat suppression when the patient is stable and CT is inconclusive',
        'Formal visual field testing once the patient is able to cooperate',
        'Comprehensive ocular examination (IOP, dilated fundus exam, assessment for globe rupture) to exclude concurrent globe injury or orbital compartment syndrome',
      ],
      initialTreatment: 'Immediate exclusion of globe rupture and orbital compartment syndrome (which requires emergent lateral canthotomy/cantholysis) takes priority over any optic nerve-directed treatment. For isolated traumatic optic neuropathy, careful observation is reasonable in most cases, since high-dose corticosteroids are no longer recommended and optic canal decompression is reserved for select cases with a clear compressive lesion.',
      followUpSchedule: 'Close early follow-up (days to 1-2 weeks) to monitor for any change in vision, then longer-interval follow-up over months to assess for stabilization and development of optic atrophy (disc pallor typically becomes evident 3-6 weeks post-injury).',
      escalationCriteria: [
        'Tense proptosis, markedly elevated IOP, and resistance to retropulsion — orbital compartment syndrome, requiring emergent lateral canthotomy/cantholysis',
        'Progressive vision loss despite stable overall trauma status — repeat imaging to exclude an expanding hematoma or displaced bone fragment',
        'A clear compressive bony fragment or hematoma on imaging correlating with progressive vision loss — consider optic canal decompression surgery',
      ],
      referralCriteria: [
        'Facial/orbital fractures, an optic canal fracture, or a compressive hematoma -> urgent oculoplastics/orbital surgery and neurosurgery',
        'All cases -> neuro-ophthalmology for ongoing monitoring',
        'Associated closed head injury -> trauma/neurosurgery team',
      ],
      steroidConsiderations: 'High-dose corticosteroids were historically used but are no longer considered standard of care: data extrapolated from the CRASH trial in traumatic brain injury raised concern for increased mortality without proven visual benefit, and the International Optic Nerve Trauma Study showed no benefit over observation.',
      complications: [
        'Permanent optic atrophy and visual field loss, in some cases progressing to no light perception',
        'Morbidity from associated orbital and intracranial injuries',
        'Missed orbital compartment syndrome leading to optic nerve infarction',
      ],
      monitoringParameters: [
        'Visual acuity',
        'RAPD grade (serial, neutral density filter)',
        'Color vision',
        'Visual fields',
        'Optic disc appearance, watching for developing pallor',
      ],
      relatedExamTechniqueIds: ['pupillary-examination', 'swinging-flashlight-test'],
    },
    followUp: {
