...
export const meta: CalculatorMeta = {
  ...
  variables: [
    { symbol: 'PD', meaning: 'Interpupillary distance (cm)' },
    { symbol: 'Hn', meaning: 'Near phoria (Δ; esophoria positive, exophoria negative)' },
    { symbol: 'Hd', meaning: 'Distance phoria (Δ; esophoria positive, exophoria negative)' },
    { symbol: 'ADD', meaning: 'Accommodative add power used to induce the near phoria (D)' },
    { symbol: 'Δphoria', meaning: 'Change in phoria through the gradient lens minus the baseline phoria (Δ)' },
    { symbol: 'ΔLens', meaning: 'Power of the lens used to induce the gradient phoria change (D)' },
  ],
