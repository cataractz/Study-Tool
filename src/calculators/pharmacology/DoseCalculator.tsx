...
export const meta: CalculatorMeta = {
  ...
  variables: [
    { symbol: 'mg', meaning: 'Dose calculated from volume and concentration (mg)' },
    { symbol: 'mL', meaning: 'Volume of solution administered (mL)' },
    { symbol: 'concentration', meaning: 'Drug concentration of the solution (mg/mL)' },
    { symbol: 'Total mg', meaning: 'Total weight-based dose (mg)' },
    { symbol: 'mg/kg', meaning: 'Weight-based dose per kilogram of body weight' },
    { symbol: 'weight', meaning: 'Patient body weight (kg)' },
    { symbol: 'Daily dose', meaning: 'Total daily dose (mg/day)' },
    { symbol: 'per-dose mg', meaning: 'Dose given at each administration (mg)' },
    { symbol: 'frequency', meaning: 'Number of administrations per day' },
  ],
