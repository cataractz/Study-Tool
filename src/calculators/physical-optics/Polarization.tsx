...
export const meta: CalculatorMeta = {
  ...
  variables: [
    { symbol: 'I', meaning: 'Transmitted light intensity' },
    { symbol: 'I₀', meaning: 'Incident light intensity' },
    { symbol: 'θ', meaning: 'Angle between the polarization axis and the polarizer/analyzer transmission axis (degrees)' },
    { symbol: 'θ_Brewster', meaning: 'Brewster\'s angle — angle of incidence at which reflected light is fully polarized (degrees)' },
    { symbol: 'n₂', meaning: 'Refractive index of the second medium (unitless)' },
    { symbol: 'n₁', meaning: 'Refractive index of the incident medium (unitless)' },
  ],
