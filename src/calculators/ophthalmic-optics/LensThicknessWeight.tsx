...
export const meta: CalculatorMeta = {
  ...
  variables: [
    { symbol: 'Δt', meaning: 'Center–edge thickness difference (mm)' },
    { symbol: 'd', meaning: 'Lens diameter (mm)' },
    { symbol: 'F', meaning: 'Lens power (D)' },
    { symbol: 'n', meaning: 'Refractive index of the lens material (unitless)' },
    { symbol: 'Weight', meaning: 'Estimated lens weight (g)' },
    { symbol: 'Volume', meaning: 'Lens volume, modeled as a flat disc (cm³)' },
    { symbol: 'Density', meaning: 'Material density (g/cm³)' },
  ],
