...
export const meta: CalculatorMeta = {
  ...
  variables: [
    { symbol: 'Sens', meaning: 'Sensitivity — probability a diseased patient tests positive (true positive rate)' },
    { symbol: 'TP', meaning: 'True positives — diseased patients who test positive' },
    { symbol: 'FN', meaning: 'False negatives — diseased patients who test negative' },
    { symbol: 'Spec', meaning: 'Specificity — probability a healthy patient tests negative (true negative rate)' },
    { symbol: 'TN', meaning: 'True negatives — healthy patients who test negative' },
    { symbol: 'FP', meaning: 'False positives — healthy patients who test positive' },
    { symbol: 'PPV', meaning: 'Positive predictive value — probability a patient testing positive actually has the disease' },
    { symbol: 'NPV', meaning: 'Negative predictive value — probability a patient testing negative is actually disease-free' },
    { symbol: 'LR+', meaning: 'Positive likelihood ratio — how much a positive result increases the odds of disease' },
    { symbol: 'LR−', meaning: 'Negative likelihood ratio — how much a negative result decreases the odds of disease' },
  ],
