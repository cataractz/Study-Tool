...
export const meta: CalculatorMeta = {
  ...
  variables: [
    { symbol: 'RR', meaning: 'Relative risk — ratio of the risk of the outcome in Group A to Group B' },
    { symbol: 'RiskA', meaning: 'Risk (incidence) of the outcome in Group A, a/(a+b)' },
    { symbol: 'RiskB', meaning: 'Risk (incidence) of the outcome in Group B, c/(c+d)' },
    { symbol: 'OR', meaning: 'Odds ratio — odds of the outcome in Group A relative to Group B' },
    { symbol: 'a', meaning: 'Group A — number of subjects with outcome present' },
    { symbol: 'd', meaning: 'Group B — number of subjects with outcome absent' },
    { symbol: 'b', meaning: 'Group A — number of subjects with outcome absent' },
    { symbol: 'c', meaning: 'Group B — number of subjects with outcome present' },
    { symbol: 'NNT', meaning: 'Number needed to treat — patients who must be treated to prevent one additional outcome' },
    { symbol: 'ARR', meaning: 'Absolute risk reduction — RiskB − RiskA' },
  ],
